...
void test_binary_command(int fd, uint8_t command, const char* name) {
...
int main() {
    ...
    printf("Dual Protocol Speeduino Test on %s\n", port);
    printf("Testing both ASCII and Binary protocols\n\n");
    ...
    printf("Starting dual protocol tests...\n\n");
    ...
    test_ascii_command(fd, "V", "Version");
    usleep(1000000);
    
    test_ascii_command(fd, "A", "Data (legacy)");
    usleep(1000000);
    
    // Test binary commands
    printf("\n=== TESTING BINARY PROTOCOL ===\n");
    test_binary_command(fd, 0x51, "Query");     // 'Q'
    usleep(1000000);
    
    test_binary_command(fd, 0x53, "Status");    // 'S'
    usleep(1000000);
    
    test_binary_command(fd, 0x56, "Version");   // 'V'
    usleep(1000000);
    
    test_binary_command(fd, 0x41, "Data");      // 'A'
    usleep(1000000);
    
    // Test some other binary commands
    test_binary_command(fd, 0x72, "Real-time Data");  // 'r'
    usleep(1000000);
